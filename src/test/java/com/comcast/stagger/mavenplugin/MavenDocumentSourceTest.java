...
import com.comcast.stagger.AbstractDocumentSource;
import com.comcast.stagger.GenerateException;
import com.comcast.stagger.TypeUtils;
import com.comcast.stagger.mustache.*;
...
public class MavenDocumentSourceTest {
    ...
    public void prepare() {
        ...
        apiSource.setFileOutputPath("sample.html");
        apiSource.setFileOutputTemplate("https://github.com/kongchen/api-doc-template/blob/master/v1.1/html.mustache");
