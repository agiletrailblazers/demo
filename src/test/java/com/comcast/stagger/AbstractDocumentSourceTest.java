...
public class AbstractDocumentSourceTest {
    ...
    private AbstractDocumentSource getAbstractDocumentSource(final boolean useOutputFlatStructure) {
        return new AbstractDocumentSource(new LogAdapter((Logger) null), null, null, null, null, useOutputFlatStructure, "", apiSource.getSwaggerUIDocBasePath()) {
            @Override
