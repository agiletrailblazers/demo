...
public class RemoteDocumentSource extends AbstractDocumentSource {
    ...
    public RemoteDocumentSource(LogAdapter logAdapter, URI requestURI, String outputTpl, String outputPath,
                                ...
                                String templatedOutputPath, String swaggerUIDocBasePath) {
        super(logAdapter, outputPath, outputTpl, swaggerOutput, mustacheFileRoot, useOutputFlatStructure, templatedOutputPath, swaggerUIDocBasePath);
