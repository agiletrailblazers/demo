...
public class OutputTemplate {
    ...
    public OutputTemplate(List<ApiListing> theListings) {
        feedSource(theListings);
    }
    ...
    private void feedSource(List<ApiListing> sourceDocuments) {
        for (ApiListing doc : sourceDocuments) {
            if (doc.apis().isEmpty()){
                continue;
            }
            MustacheDocument mustacheDocument = createMustacheDocument(doc);
